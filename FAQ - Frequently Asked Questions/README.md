...
3. [OneAgent vs OpenTelemetry for Java/Scala — Convert, Layer, or Leave Alone?](markdown/-[FAQ]-03-oneagent-vs-otel-java-scala.md) — Effort-vs-capability trade-offs for OTel-instrumented Java/Scala/Kotlin/Groovy backends, with side-by-side capability gaps and a layering recommendation
