# IAMADM-10: Templated Policy-Group Assignments

> **Series:** IAMADM | **Notebook:** 10 of 10 | **Created:** February 2026 | **Last Updated:** 02/25/2026
...
| **Prior Knowledge** | **IAMADM-04: Policy Authoring and Management** (policy syntax, conditions) |
...
For comprehensive IAM troubleshooting, see **IAMADM-09: Troubleshooting Access Issues**.
...
- **IAMADM-05: Boundary Design Patterns** — Combine templated policies with boundaries for defense in depth
- **IAMADM-07: Audit Logging and Compliance** — Set up ongoing audit monitoring for policy bindings
