...
> **Series:** M2S | **Notebook:** 5 of 8 | **Created:** January 2026 | **Last Updated:** 01/28/2026
...
2. [Configuration Categories](#categories)
3. [Settings API Migration](#settings-api)
4. [Dashboard Migration](#dashboards)
5. [Alerting Migration](#alerting)
6. [Automation Migration](#automation)
